...
import { buildPositionListCsv, docToRows } from '../lib/gaeb';
...
export default function PositionListExport({ files }: PositionListExportProps) {
  ...
  const handleExport = () => {
    // CSV is single-sheet; multiple files are concatenated with a header
    // line that names the source file before each block.
      ...
      <div className="flex items-start justify-between mb-4 gap-4">
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
            CSV-Export mit Pos.-Nr., Kurztext, Menge, EP/GP und den Preisanteilen
            Lohn/Stoff/Gerät/Sonstiges — direkt aus dem Domain-Modell. Öffnet
            sich nativ in Excel, LibreOffice und Numbers.
          </p>
        ...
        >
          Positionsliste exportieren (.csv)
        </button>
      </div>
